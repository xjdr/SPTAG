...
BOOST_AUTO_TEST_CASE(IniReaderLoadTest) {
  ...
  BOOST_CHECK(
      std::string("Exp=2") ==
      reader.GetParameter<std::string>("Common", "Param2", std::string()));
  BOOST_CHECK(
      std::string("1") ==
      reader.GetParameter<std::string>("Common", "Param1", std::string()));
  BOOST_CHECK(std::string() ==
              reader.GetParameter<std::string>("Common", "ParamNotExist",
                                               std::string()));
}
