...
BOOST_AUTO_TEST_CASE(ConvertIndexAlgoType) {
  Local::TestConvertSuccCase<SPTAG::IndexAlgoType>(SPTAG::IndexAlgoType::BKT,
                                                   "BKT");
  Local::TestConvertSuccCase<SPTAG::IndexAlgoType>(SPTAG::IndexAlgoType::KDT,
                                                   "KDT");
}

BOOST_AUTO_TEST_CASE(ConvertVectorValueType) {
  Local::TestConvertSuccCase<SPTAG::VectorValueType>(
      SPTAG::VectorValueType::Float, "Float");
  Local::TestConvertSuccCase<SPTAG::VectorValueType>(
      SPTAG::VectorValueType::Int8, "Int8");
  Local::TestConvertSuccCase<SPTAG::VectorValueType>(
      SPTAG::VectorValueType::Int16, "Int16");
}

BOOST_AUTO_TEST_CASE(ConvertDistCalcMethod) {
  Local::TestConvertSuccCase<SPTAG::DistCalcMethod>(
      SPTAG::DistCalcMethod::Cosine, "Cosine");
  Local::TestConvertSuccCase<SPTAG::DistCalcMethod>(SPTAG::DistCalcMethod::L2,
                                                    "L2");
}
