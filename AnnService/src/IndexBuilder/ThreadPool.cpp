...
void ThreadPool::Init(std::uint32_t p_threadNum) {
...
bool ThreadPool::Queue(std::function<void()> p_workItem) {
...
std::uint32_t ThreadPool::CurrentThreadNum() { return Local::g_threadNum; }
