...
bool Encode(const std::uint8_t* p_in, std::size_t p_inLen, char* p_out,
            std::size_t& p_outLen);

bool Encode(const std::uint8_t* p_in, std::size_t p_inLen, std::ostream& p_out,
            std::size_t& p_outLen);

bool Decode(const char* p_in, std::size_t p_inLen, std::uint8_t* p_out,
            std::size_t& p_outLen);
